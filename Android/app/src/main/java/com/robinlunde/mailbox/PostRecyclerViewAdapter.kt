...
class PostRecyclerViewAdapter internal constructor(data: List<String>, context: Context, val clickListener: (Int) -> Unit) :
    ...
    inner class ViewHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        var myTextView: TextView = itemView.findViewById(R.id.post_entry)
